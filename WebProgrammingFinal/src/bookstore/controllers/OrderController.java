...
public class OrderController extends HttpServlet {
    ...
    private String updateItem(HttpServletRequest request,
        ...
        if (product != null && cart != null) {
            LineItem lineItem = new LineItem();
            lineItem.setProduct(product);
            //Cant order more than current stock
    ...
    private String checkUser(HttpServletRequest request,
        ...
        if (user != null && user.getAddress1() != null && !user.getAddress1().equals("")) {
    ...
    private String completeOrder(HttpServletRequest request,
        ...
        if(cart != null) {
            ...
            if(itemList.size() > 0) {
                for(LineItem item : itemList) {
                    ...
                    Product p = ProductDB.selectProduct(isbn13);
        ...
        //Cart changed due to change in stock
        if(cartChanged) {
            session.setAttribute("cartChanged", cartChanged);
            session.setAttribute("cart",cart);
        ...
        String from = "christran206@gmail.com";
