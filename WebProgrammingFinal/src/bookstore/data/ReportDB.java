...
public class ReportDB {
    ...
    public static Workbook getUserEmail() {
        ...
        row.createCell(9).setCellValue("UserID");
        ...
        try {
            ...
            while (rs.next()) {
                ...
                row.createCell(3).setCellValue(rs.getString("Address1"));
                row.createCell(4).setCellValue(rs.getString("Address2"));
                ...
                row.createCell(9).setCellValue(rs.getInt("UserID"));
                i++;
            }
            return workbook;
